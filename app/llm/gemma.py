...
class GemmaProvider(LLMProvider):
    ...
    def generate(
        ...
        # Le richieste strutturate e molto brevi sono usate
        # dall'Agent Planner. Per queste richieste il thinking
        # aggiunge latenza inutile e può sporcare il JSON finale.
