...
class AgentPlanner:
    ...
    def _build_system_prompt(
        ...
        system_content = (
            ...
            "- per richieste come 'directory del progetto', usa la radice Git "
            "presente nel contesto quando disponibile, altrimenti usa la "
            "directory di lavoro corrente; non inventare mai percorsi come "
            "C:\\\\workspace o simili;\n\n"
