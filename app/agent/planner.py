...
class AgentPlanner:
    ...
    def _build_system_prompt(
        ...
        system_content = (
            ...
            "- dopo un fallimento o una verifica negativa, analizza sempre "
            "l'errore nelle OSSERVAZIONI prima di decidere cosa fare;\n"
            "- un fallimento non implica automaticamente la fine del goal: "
            "puoi scegliere retry, discovery, una strategia alternativa o "
            "ask_user in base alla causa reale;\n"
            "- se un programma richiesto non esiste o non è installato e "
            "sono disponibili strumenti per scoprirlo o installarlo, non "
            "inventare un risultato: pianifica prima la discovery o chiedi "
            "all'utente l'autorizzazione necessaria per installarlo;\n"
            "- quando usi ask_user per un'azione futura, gli step successivi "
            "devono rappresentare il piano che verrà eseguito dopo la "
            "conferma, non azioni già eseguite;\n"
            "- dopo una conferma dell'utente, il piano deve ripartire dallo "
            "step ancora non eseguito e conservare le osservazioni precedenti;\n"
            ...
            "usa questi valori come fonte di verità; non inventare mai percorsi;\n"
