...
def test_move_replan_resolves_search_observation() -> None:
    planner = AgentPlanner(MoveRouter())

    source = r"C:\test\test_file4598589343584980934093540934.txt"
    other = r"C:\test\test_file_old.txt"
    root = r"C:\test"
    ...
    observation = AgentObservation(
        ...
        output={
            "results": [
                {
                    "path": other,
                    "name": "test_file_old.txt",
                    "is_file": True,
                    "modified_at": "2026-09-24T10:00:00+00:00",
                },
                {
                    "path": source,
                    "name": "test_file4598589343584980934093540934.txt",
                    "is_file": True,
                    "modified_at": "2026-09-25T18:50:00+00:00",
                },
            ]
        },
        verified=True,
    ...
    plan = planner.plan(
        goal="Sposta il file di test in un altra posizione",
        context=f"AMBIENTE REALE DEL PROCESSO:\n- RADICE GIT DEL PROGETTO: {root}\n",
        tool_definitions=[
            {
                "name": "search_files",
                "description": "Cerca file.",
